...
<html lang="en" dir="ltr">
  <head>
    ...
    <script src="/js/app_common.js" defer></script>
  </head>
  ...
  <body>
    ...
    <?php
      ...
      $sqlc = "SELECT word, definition FROM words_common";
    ...
    <div class="containerG">
      <div class="leftM">
        <h3>Самые распространенные слова</h3>
      ...
      <div class="but">
        <a href="#" class="btn btn-outline-light" onclick="updateWords_common()" role="button"> Следующее слово </a>
      </div>
